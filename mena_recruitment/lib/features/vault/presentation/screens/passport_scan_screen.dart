      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                      ...
                      children: [
                        const Row(
                          children: [
                            ...
                            SizedBox(width: 6),
                            Text('BIO-PAGE OPTICAL VIEWFINDER', style: TextStyle(color: Colors.white70, fontSize: 9, fontWeight: FontWeight.w700)),
                          ],
                        ),
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                          decoration: BoxDecoration(color: const Color(0xFFD1FAE5), borderRadius: BorderRadius.circular(4)),
                          child: const Text('99.4% CONFIDENCE', style: TextStyle(color: Color(0xFF065F46), fontSize: 8, fontWeight: FontWeight.w800)),
                        ),
                      ],
                    ),
                  ),
                  // Simulated Passport in scanner
                  Container(
                      ...
                      children: [
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: const Row(
                              children: [
                                CircleAvatar(radius: 12, backgroundImage: NetworkImage('https://i.pravatar.cc/150?img=11')),
                                SizedBox(width: 6),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                        ...
                        Center(
                          child: Container(
                            ...
                            child: const Row(
                              ...
                              children: [
                                Icon(Icons.sync, size: 12, color: Color(0xFF34D399)),
                                SizedBox(width: 4),
                                Text('PASSPORT BIO-ALIGNED', style: TextStyle(color: Colors.white, fontSize: 9, fontFamily: 'monospace', fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ),
            ...
            // Extracted Fields Grid (from Screenshot 2)
              ...
              child: Row(
                ...
                children: [
                  const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('PASSPORT NUMBER', style: TextStyle(fontSize: 9, fontWeight: FontWeight.w700, color: Color(0xFF5B403C))),
                      SizedBox(height: 2),
                      Text('N8492014', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w800, color: Color(0xFF1E1B1B), fontFamily: 'monospace')),
                    ],
                  ),
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      const Icon(Icons.edit_outlined, size: 16, color: Color(0xFF5B403C)),
                    ],
                  ),
                ],
              ),
              ...
              child: const Row(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('FULL LEGAL NAME (ICAO DOC FORMAT)', style: TextStyle(fontSize: 9, fontWeight: FontWeight.w700, color: Color(0xFF5B403C))),
                      SizedBox(height: 2),
                      Text('AHMED MANSOOR AL-FAROOQ', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: Color(0xFF1E1B1B))),
                      SizedBox(height: 2),
                      Text('Primary: AL-FAROOQ • Given: AHMED MANSOOR', style: TextStyle(fontSize: 9, color: Color(0xFF64748B), fontFamily: 'monospace')),
                    ],
                  ),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInfoCard('NATIONALITY', '🇪🇬 Egyptian (EGY)'),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _buildInfoCard('GENDER', 'Male (M)'),
                ),
              ],
            ),
            const SizedBox(height: 8),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInfoCard('DATE OF BIRTH', '14 APR 1989', sub: 'Age: 35 Years'),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _buildInfoCard('PLACE OF ISSUE', 'Cairo, Egypt', sub: 'Authority: 03-GIZA'),
                ),
              ],
            ),
            const SizedBox(height: 8),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInfoCard('DATE OF ISSUE', '10 JAN 2021', sub: 'Format: DD MMM YYYY'),
                ),
                const SizedBox(width: 8),
                Expanded(
                  child: _buildInfoCard('DATE OF EXPIRY', '09 JAN 2028', sub: '2.8 Yrs Remaining', isGreenSub: true),
                ),
              ],
            ),
            const SizedBox(height: 8),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'P<EGYAL<FAROOQ<<AHMED<<<<<<<<<<<<<<<<<<<<<<<\nN8492014<8EGY8904146M2801095<<<<<<<<<<<<<<<<',
                    style: TextStyle(color: Color(0xFFE2E8F0), fontSize: 10, fontFamily: 'monospace', height: 1.5),
                  ),
                ],
              ),
            ),
